					...
					<div class="container">
							...
							<nav id="nav">
								<ul>
									...
									<li><a href="news.html">VIT News</a></li>
									<li><a href="events.html">VIT Events</a></li>
					...
					<div class="row">
						...
						<div id="content" class="8u skel-cell-important">
							<div id="logout" align="right">
								<form action="logout.php" method="post" name="login" onsubmit="">
									<input type="submit" value = "Logout"/>
								</form>
							</div>
							<section>
								<?php
										echo "<h2> Welcome ".$_SESSION["login_user"]."</h2><br><br>" ;
								?>
								<header class="major">
									<h2>EVENTS</h2>

									<span class="byline">Major events happening in VIT posted by students itself.</span>
									
								</header>
								<p>will be fetched by database</p>
							</section>
